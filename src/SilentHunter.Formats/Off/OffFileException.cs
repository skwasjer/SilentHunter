...
namespace SilentHunter.Off
{
	...
	{
		/// <summary>
		/// Initializes a new instance of <see cref="OffFileException" />.
		/// </summary>
		...
		public OffFileException(int itemIndex, long fileOffset, string message, Exception innerException)
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="OffFileException" /> class with serialized data.
		/// </summary>
		...
		protected OffFileException(SerializationInfo info, StreamingContext context)
			: base(info, context)
		{
