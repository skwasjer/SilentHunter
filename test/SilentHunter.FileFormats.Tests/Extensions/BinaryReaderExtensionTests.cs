...
public class BinaryReaderExtensionTests
{
    ...
    {
        var expected = System.Drawing.Color.FromArgb(0x33, 0x66, 0x99, 0xcc);
        using var reader = new BinaryReader(new MemoryStream([expected.A, expected.R, expected.G, expected.B]));
        System.Drawing.Color color = reader.ReadStruct<System.Drawing.Color>();
    ...
    public void it_will_read_enum()
    {
        ...
        IntEnum value = reader.ReadStruct<IntEnum>();
    ...
    public void it_will_read_enum_using_alternate_underlying_type()
    {
        ...
        LongEnum value = reader.ReadStruct<LongEnum>();
        value.Should().Be(expected);
        reader.BaseStream.Should().BeEof();
    }
    ...
    {
        using var reader = new BinaryReader(new MemoryStream([0xA0]));
    ...
    {
        using var reader = new BinaryReader(new MemoryStream([0]));
        bool value = reader.ReadStruct<bool>();
    ...
    public void it_will_read_struct()
    {
        ...
        byte[] source = [0x10, 0xf0, 0x44, 0xd5, 0xbc, 0x2a, 0x00, 0x44, 0xf5, 0xbf, 0x00, 0xbc, 0x0a, 0x40, 0x00, 0x00, 0x00, 0x44, 0xf5, 0xff, 0xff, 0x8f, 0x00, 0x00, 0x00, 0xbc, 0x0a, 0x00, 0x00, 0x70, 0x01, 0x00, 0x00, 0x00, 0xb6, 0xe6, 0x40, 0x46, 0x75, 0x6b, 0x7e, 0x54, 0x34, 0x6f, 0x9d, 0x41, 0x00, 0x00, 0x09, 0x00, 0x00, 0x00, 0x00, 0x00, 0x15, 0x5f, 0xd0, 0xac, 0x4b, 0x9b, 0xb6, 0x01];

        using var reader = new BinaryReader(new MemoryStream(source));
        CustomStruct value = reader.ReadStruct<CustomStruct>();
        value.Should().Be(expected);
        reader.BaseStream.Should().BeEof();
    ...
    public void it_will_read_struct_with_string_byval()
    {
        ...
        byte[] source = [];

        using var reader = new BinaryReader(new MemoryStream(source));
        StringStructByval value = reader.ReadStruct<StringStructByval>();
        value.Should().Be(expected);
        reader.BaseStream.Should().BeEof();
    }
    ...
    {
        using var reader = new BinaryReader(new MemoryStream([0, 1, 2, 3]));
